    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4 relative overflow-hidden">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border-t-4 border-camp-main z-10">
              <form onSubmit={handleLogin} className="space-y-6">
                 <div>
                    <label className="block text-gray-700 text-sm font-bold mb-2 ml-1">รหัสนักศึกษา</label>
                    <input 
                      type="text" 
                      value={studentId}
                  ...
                  <div>
                    <label className="block text-gray-700 text-sm font-bold mb-2 ml-1">PIN</label>
                    <input 
                      type="password" 
                      value={pin}
